...
public class DepartmentController {
    ...
    @ResponseBody
    public UIPage<Department> findPage(DepartmentQuery baseQuery) {
        Page page = departmentService.findPageByQuery(baseQuery);
    ...
    public Department beforeEdit(Long id, String cmd) {
        if (id != null && "_update".equals(cmd)) {
             ...
             * 这个错误的原因是：当修改部门的时候，实际上是修改的department对应的持久化对象的department持久化对象的oid
