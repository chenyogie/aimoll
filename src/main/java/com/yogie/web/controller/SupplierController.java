...
public class SupplierController {
    ...
    @ResponseBody
    public UIPage<Supplier> findPage(SupplierQuery baseQuery) {
        Page page = supplierService.findPageByQuery(baseQuery);
    ...
    public Supplier beforeEdit(Long id, String cmd) {
        if (id != null && "_update".equals(cmd)) {
             ...
             * 这个错误的原因是：当修改部门的时候，实际上是修改的supplier对应的持久化对象的department持久化对象的oid
