...
<html>
<head>
    <title>systemdictionarytype.jsp</title>
...
<table id="systemdictionarytypeGrid" class="easyui-datagrid" fit="true"
       data-options="url:'/systemdictionarytype/findPage',fitColumns:true,
...
<%--对话框--%>
<div id="systemdictionarytypeDialog" class="easyui-dialog" style="width:345px;padding-left: 35px;padding-right: 35px;padding-top: 15px;"
