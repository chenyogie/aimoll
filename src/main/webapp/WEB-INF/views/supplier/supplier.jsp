...
<table id="supplierGrid" class="easyui-datagrid" fit="true"
       data-options="url:'/supplier/findPage',fitColumns:true,
...
<%--对话框--%>
<div id="supplierDialog" class="easyui-dialog" style="width:345px;padding-left: 35px;padding-right: 35px;padding-top: 15px;"
