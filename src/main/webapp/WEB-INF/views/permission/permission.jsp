...
<table id="permissionGrid" class="easyui-datagrid" fit="true"
       data-options="url:'/permission/findPage',fitColumns:true,
    ...
    <tr>
        ...
        <th data-options="field:'url',width:100" align="center">对应的资源</th>
        <th data-options="field:'sn',width:100" align="center">对象的权限</th>
...
<%--对话框--%>
<div id="permissionDialog" class="easyui-dialog"
