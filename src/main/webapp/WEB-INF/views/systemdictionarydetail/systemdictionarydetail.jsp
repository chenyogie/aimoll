...
<html>
<head>
    <title>systemdictionarydetail.jsp</title>
...
<table id="systemdictionarydetailGrid" class="easyui-datagrid" fit="true"
       data-options="url:'/systemdictionarydetail/findPage',fitColumns:true,
    ...
    <thead>
        <tr>
            <th data-options="field:'',checkbox:true,width:50,checkbox:true" align="center"></th>
                                            ...
                                            <th data-options="field:'typesId',width:100" align="center">typesId</th>
                    </tr>
    </thead>
</table>
<%--datagrid顶部工具栏--%>
...
<%--对话框--%>
<div id="systemdictionarydetailDialog" class="easyui-dialog" style="width:345px;padding-left: 35px;padding-right: 35px;padding-top: 15px;"
    ...
    <form id="editForm" method="post">
        ...
        <table>
            ...
            <td>
                <input class="easyui-validatebox" type="text" name="typesId"
                      data-options="required:true"/>
            </td>
        </tr>
                </table>
