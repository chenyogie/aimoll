...
<table id="producttypeGrid" class="easyui-datagrid" fit="true"
       data-options="url:'/producttype/findPage',fitColumns:true,
...
<%--对话框--%>
<div id="producttypeDialog" class="easyui-dialog" style="width:345px;padding-left: 35px;padding-right: 35px;padding-top: 15px;"
     data-options="title:'编辑功能',buttons:'#editBtn',modal:true,closed:true">
    <form id="editForm" method="post">
        <%--当修改的时候，把id传到后台--%>
        <input id="producttypeId" type="hidden" name="id">
        <table>
                        <tr>
            <td>
                <label>name:</label>
